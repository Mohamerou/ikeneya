...
@section('content')
    ...
    <section class="banner-area other-page">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Les hopitaux partenaires</h1>
                ...
                <div class="col-lg-12">
                    <div class="department-slider owl-carousel">
                        <div class="single-slide">
                            <div class="slide-img">
                                <img src="{{ asset('landing-page/assets/images/department1.jpg') }}" alt="" class="img-fluid">
                        ...
                        <div class="single-slide">
                            <div class="slide-img">
                                <img src="{{ asset('landing-page/assets/images/department2.jpg') }}" alt="" class="img-fluid">
                                <div class="hover-state">
                        ...
                        <div class="single-slide">
                            <div class="slide-img">
                                <img src="{{ asset('landing-page/assets/images/department3.jpg') }}" alt="" class="img-fluid">
                                <div class="hover-state">
                                    <a href="departments.html"><i class="fa fa-stethoscope"></i></a>
                                </div>
                            </div>
